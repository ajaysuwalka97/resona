...
6) Before the first tool call, give one reflective paraphrase:
   "What I'm hearing is ...", then ask one precision nudge.
   This precision nudge should be the Step 3 complementarity-inference nudge below, not an extra fourth question.
...
7) Call find_match only after the live need is clear in the founder's own terms:
   ...
   - If context is still imperfect after 3 questions, infer a freeform need_dimension + summary and call find_match.
